...
class TestProductionTierValidation(common.SavepointCase):
    @classmethod
    def setUpClass(cls):
        super(TestProductionTierValidation, cls).setUpClass()
    ...
    def tearDownClass(cls):
        ...
        super(TestProductionTierValidation, cls).tearDownClass()
    ...
    def test_01_tier_definition_models(self):
        ...
        self.assertIn("mrp.production", res)
